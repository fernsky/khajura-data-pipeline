...
#setting up logging
logging.basicConfig(
    level=logging.INFO,  # Fixed the case of INFO
...
def transform_household_base_data(df):
    ...
    df['base_type_mapped'] = df['house_base'].apply(map_base_type)
...
def process_ward_wise_household_base(source_conn, target_conn, generate_sql=True):
    ...
    try:
        ...
        # Load data
        load_household_base_data(transformed_df, target_conn, generate_sql)
